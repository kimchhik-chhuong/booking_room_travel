...
class _TripScreenState extends State<TripScreen> {
  ...
  final List<Map<String, dynamic>> _provinces = [
      ...
      'places': [
        {
          ...
          'imageUrls': [
            'https://via.placeholder.com/600x400/8B0000/FFFFFF?text=Royal+Palace+1',
    'https://via.placeholder.com/600x400/8B0000/FFFFFF?text=Royal+Palace+2',
    'https://via.placeholder.com/600x400/8B0000/FFFFFF?text=Royal+Palace+3',
    'https://via.placeholder.com/600x400/8B0000/FFFFFF?text=Royal+Palace+4',
    'https://via.placeholder.com/600x400/8B0000/FFFFFF?text=Royal+Palace+5',
          ],
          'location': 'Phnom Penh',
          'latitude': 11.5540,
          'longitude': 104.9144,
      ...
      'places': [
        {
          ...
          'imageUrls': [
            'http://googleusercontent.com/file_content/0', // Your actual image
      ...
      'places': [
        {
          ...
          'imageUrls': [
            'http://googleusercontent.com/file_content/1', // Your actual image
    ...
    },
    {
      ...
      'places': [
        {
          'name': 'Tataii Waterfall',
          'shortDescription': 'Beautiful waterfall, popular for swimming.',
          'fullDescription': 'Tataii Waterfall is a picturesque tiered waterfall surrounded by lush jungle, perfect for a refreshing swim and relaxation in nature. Boat trips often include a stop here, providing a serene escape into the wilderness of Koh Kong\'s untouched landscapes.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/800080/FFFFFF?text=Tataii+Waterfall+1',
            'https://via.placeholder.com/600x400/800080/FFFFFF?text=Tataii+Waterfall+2',
            'https://via.placeholder.com/600x400/800080/FFFFFF?text=Tataii+Waterfall+3',
            'https://via.placeholder.com/600x400/800080/FFFFFF?text=Tataii+Waterfall+4',
            'https://via.placeholder.com/600x400/800080/FFFFFF?text=Tataii+Waterfall+5'
          ],
          'location': 'Near Koh Kong City',
          'latitude': 11.5833,
          'longitude': 103.3500,
          'bestTime': 'Wet season for fuller falls.'
        },
      ],
      'hotels': [
        {
          'name': 'Koh Kong Resort',
          'shortDescription': 'Riverside resort with various amenities.',
          'fullDescription': 'Koh Kong Resort offers a range of accommodation options along the river, providing a gateway to exploring the province\'s natural beauty, from waterfalls to mangrove forests. It\'s a good base for adventure tourism and relaxation by the water.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/FFA500/000000?text=Koh+Kong+Resort+1',
            'https://via.placeholder.com/600x400/FFA500/000000?text=Koh+Kong+Resort+2'
          ],
      ...
      'places': [
        {
          ...
          'shortDescription': 'Best spot to see the rare Irrawaddy dolphins.',
          'fullDescription': 'Kampi is one of the best places in the world to spot the critically endangered Irrawaddy dolphins. Boat tours offer close-up views of these unique freshwater dolphins in their natural habitat, making for a memorable wildlife encounter and supporting conservation efforts.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/00FFFF/000000?text=Dolphin+Pool+1',
            'https://via.placeholder.com/600x400/00FFFF/000000?text=Dolphin+Pool+2',
            'https://via.placeholder.com/600x400/00FFFF/000000?text=Dolphin+Pool+3',
            'https://via.placeholder.com/600x400/00FFFF/000000?text=Dolphin+Pool+4',
            'https://via.placeholder.com/600x400/00FFFF/000000?text=Dolphin+Pool+5'
          ],
          'location': 'North of Kratié',
          'latitude': 12.6000,
          'longitude': 106.0000,
          'bestTime': 'Dry season for clearer water.'
        },
      ],
      'hotels': [
        {
          'name': 'Le Tonle Guesthouse',
          'shortDescription': 'Community-based tourism guesthouse.',
          'fullDescription': 'Le Tonle Guesthouse is a socially responsible establishment that supports local youth through hospitality training. It offers clean, comfortable rooms and a warm atmosphere, with a focus on sustainable and ethical tourism, allowing guests to contribute positively to the community.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/40E0D0/000000?text=Le+Tonle+1',
            'https://via.placeholder.com/600x400/40E0D0/000000?text=Le+Tonle+2'
          ],
          ...
          'rating': 4.0,
          'priceRange': '\$\$',
          'amenities': ['Restaurant', 'Support Local Community', 'Free Wi-Fi', 'Cooking Classes']
        },
      ]
    },
    {
      ...
      'places': [
        {
          'name': 'Busra Waterfall',
          'shortDescription': 'Cambodia\'s largest and most famous waterfall.',
          'fullDescription': 'Busra Waterfall is a stunning three-tiered waterfall, one of Cambodia\'s most impressive natural attractions. It\'s a great spot for swimming, picnicking, and enjoying the cool highland air, especially beautiful during the wet season when the water flow is strongest.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/ADD8E6/000000?text=Busra+Waterfall+1',
            'https://via.placeholder.com/600x400/ADD8E6/000000?text=Busra+Waterfall+2',
            'https://via.placeholder.com/600x400/ADD8E6/000000?text=Busra+Waterfall+3',
            'https://via.placeholder.com/600x400/ADD8E6/000000?text=Busra+Waterfall+4',
            'https://via.placeholder.com/600x400/ADD8E6/000000?text=Busra+Waterfall+5'
          ],
          'location': 'Pech Chreada District',
          'latitude': 12.4790,
          'longitude': 107.4100,
          'bestTime': 'Wet season for fullest flow.'
        },
      ],
      'hotels': [
        {
          'name': 'Mondulkiri Hotel',
          'shortDescription': 'Comfortable hotel in Sen Monorom.',
          'fullDescription': 'The Mondulkiri Hotel offers comfortable and convenient accommodation in Sen Monorom, the provincial capital, serving as a good base for exploring the region\'s natural beauty and indigenous culture. It provides essential services for a pleasant stay.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/DDA0DD/FFFFFF?text=Mondulkiri+Hotel+1'
          ],
          ...
          'rating': 3.0,
          'priceRange': '\$\$',
          'amenities': ['Restaurant', 'Wi-Fi', '24-hour Front Desk', 'Tour Desk']
        },
      ]
    },
    {
      ...
      'places': [
        {
          'name': 'Anlong Veng',
          'shortDescription': 'Former Khmer Rouge stronghold with historical sites.',
          'fullDescription': 'Anlong Veng holds significant historical importance as the last stronghold of the Khmer Rouge. Visitors can see the grave of Pol Pot and other sites related to the regime, offering a somber but important historical lesson and a stark reminder of Cambodia\'s past.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/F08080/FFFFFF?text=Anlong+Veng+1',
            'https://via.placeholder.com/600x400/F08080/FFFFFF?text=Anlong+Veng+2'
          ],
          'location': 'Anlong Veng District',
          'latitude': 14.2833,
          'longitude': 103.8500,
          'bestTime': 'Dry season.'
        },
      ...
      'hotels': [
        {
          'name': 'Samraong Guesthouse',
          'shortDescription': 'Basic accommodation in the provincial capital.',
          'fullDescription': 'A simple and clean guesthouse providing essential comforts for travelers exploring the remote and historically significant areas of Oddar Meanchey. It offers a practical and budget-friendly base for adventurers.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/FAEBD7/000000?text=Samraong+Guesthouse+1'
          ],
          'location': 'Samraong City',
          'latitude': 14.1800,
          'longitude': 103.3500,
          'rating': 2.5,
          'priceRange': '\$'
    ...
    {
      'name': 'Pailin',
      'details': 'A small western province known for its rich gem deposits and past as a Khmer Rouge stronghold.',
      'places': [
        {
          'name': 'Phnom Yat',
          'shortDescription': 'Hilltop pagoda with a large reclining Buddha and scenic views.',
          'fullDescription': 'Phnom Yat is a significant spiritual site in Pailin, featuring a hilltop pagoda with a large reclining Buddha and offering panoramic views of the surrounding area, historically known for gem mining. It\'s a peaceful place for contemplation and cultural discovery.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/D2B48C/000000?text=Phnom+Yat+1',
            'https://via.placeholder.com/600x400/D2B48C/000000?text=Phnom+Yat+2',
            'https://via.placeholder.com/600x400/D2B48C/000000?text=Phnom+Yat+3',
            'https://via.placeholder.com/600x400/D2B48C/000000?text=Phnom+Yat+4',
            'https://via.placeholder.com/600x400/D2B48C/000000?text=Phnom+Yat+5'
          ],
      ...
      'hotels': [
        {
          'name': 'Pailin Hotel',
          'shortDescription': 'Local hotel catering to visitors.',
          'fullDescription': 'A straightforward local hotel providing comfortable lodging for visitors to Pailin, suitable for those exploring the province\'s unique history and natural resources. It offers essential amenities for a pleasant and convenient stay in the city center.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/A0522D/FFFFFF?text=Pailin+Hotel+1'
          ],
          'location': 'Pailin City',
          'latitude': 12.8430,
          'longitude': 102.6130,
    ...
    {
      'name': 'Preah Sihanouk',
      'details': 'A coastal province famous for its beaches, islands, and developing tourism industry.',
      'places': [
        {
          'name': 'Otres Beach',
          'shortDescription': 'Relaxed beach with guesthouses and restaurants.',
          'fullDescription': 'Otres Beach offers a more laid-back atmosphere compared to other Sihanoukville beaches, with calm waters, beachfront guesthouses, and seafood restaurants. It\'s great for swimming, sunbathing, and enjoying the quiet coastal atmosphere away from the main town bustle.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/00BFFF/FFFFFF?text=Otres+Beach+1',
            'https://via.placeholder.com/600x400/00BFFF/FFFFFF?text=Otres+Beach+2',
            'https://via.placeholder.com/600x400/00BFFF/FFFFFF?text=Otres+Beach+3',
            'https://via.placeholder.com/600x400/00BFFF/FFFFFF?text=Otres+Beach+4',
            'https://via.placeholder.com/600x400/00BFFF/FFFFFF?text=Otres+Beach+5'
          ],
      ...
      'hotels': [
        {
          ...
          'fullDescription': 'Sokha Beach Resort is a sprawling luxury resort with its own private white-sand beach, multiple pools, and a wide range of facilities, ideal for families and those seeking a resort experience with all amenities at hand. It offers a blend of relaxation and activity.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/6495ED/FFFFFF?text=Sokha+Beach+1',
            'https://via.placeholder.com/600x400/6495ED/FFFFFF?text=Sokha+Beach+2',
            'https://via.placeholder.com/600x400/6495ED/FFFFFF?text=Sokha+Beach+3',
            'https://via.placeholder.com/600x400/6495ED/FFFFFF?text=Sokha+Beach+4',
            'https://via.placeholder.com/600x400/6495ED/FFFFFF?text=Sokha+Beach+5'
          ],
          'location': 'Sihanoukville',
          'latitude': 10.6180,
          'longitude': 103.5290,
          'rating': 4.5,
          'priceRange': '\$\$\$\$\$',
          'amenities': ['Private Beach', 'Multiple Pools', 'Spa', 'Kids Club', 'Water Sports', 'Fitness Center']
        },
      ]
    },
    {
      'name': 'Preah Vihear',
      'details': 'Home to the stunning Preah Vihear Temple, a UNESCO World Heritage site, located on the border with Thailand.',
      'places': [
        {
          'name': 'Preah Vihear Temple',
          'shortDescription': 'Ancient Khmer temple perched on a cliff.',
          'fullDescription': 'Preah Vihear Temple is a spectacular 11th-century Khmer temple perched on a cliff overlooking the Cambodian plains. It\'s a UNESCO World Heritage site known for its unique architecture and breathtaking views, a true marvel of ancient engineering and art, offering historical depth and spiritual significance.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/4169E1/FFFFFF?text=Preah+Vihear+Temple+1',
            'https://via.placeholder.com/600x400/4169E1/FFFFFF?text=Preah+Vihear+Temple+2',
            'https://via.placeholder.com/600x400/4169E1/FFFFFF?text=Preah+Vihear+Temple+3',
            'https://via.placeholder.com/600x400/4169E1/FFFFFF?text=Preah+Vihear+Temple+4',
            'https://via.placeholder.com/600x400/4169E1/FFFFFF?text=Preah+Vihear+Temple+5'
          ],
      ...
      'hotels': [
        {
          ...
          'shortDescription': 'Comfortable stay near the temple.',
          'fullDescription': 'A comfortable boutique hotel offering modern amenities and a convenient location for visiting Preah Vihear Temple and exploring the surrounding area. It provides a peaceful base for temple adventurers and cultural explorers, with a focus on guest comfort.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/0000CD/FFFFFF?text=Preah+Vihear+Hotel+1'
          ],
          'location': 'Tbeng Meanchey',
          'latitude': 13.9800,
          'longitude': 104.9800,
          'rating': 3.5,
          'priceRange': '\$\$',
          'amenities': ['Restaurant', 'Free Wi-Fi', 'Garden', 'Room Service']
        },
      ]
    },
    {
      'name': 'Prey Veng',
      'details': 'An agricultural province in the southeastern plains, known for its rice fields and local markets.',
      'places': [
        {
          'name': 'Ba Phnom',
          'shortDescription': 'A small mountain with a pagoda and historical significance.',
          'fullDescription': 'Ba Phnom is a significant cultural site, featuring a small mountain with ancient pagodas and shrines, offering historical context and pleasant views of the surrounding rice fields. It\'s a popular local pilgrimage site, especially during festivals.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/8B008B/FFFFFF?text=Ba+Phnom+1',
            'https://via.placeholder.com/600x400/8B008B/FFFFFF?text=Ba+Phnom+2'
          ],
          'location': 'Ba Phnom District',
          'latitude': 11.2300,
          'longitude': 105.4700,
          'bestTime': 'Daytime.'
        },
      ...
      'hotels': [
        {
          'name': 'Prey Veng Guesthouse',
          'shortDescription': 'Basic and clean accommodation.',
          'fullDescription': 'A straightforward guesthouse offering essential lodging for travelers passing through Prey Veng or exploring the local area. It provides a comfortable and practical stopover for weary travelers, with a focus on cleanliness and basic services.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/8A2BE2/FFFFFF?text=Prey+Veng+Guesthouse+1'
          ],
          'location': 'Prey Veng City',
          'latitude': 11.4800,
          'longitude': 105.3200,
          'rating': 2.5,
          'priceRange': '\$',
    ...
    },
    {
      ...
      'places': [
        {
          'name': 'Areng Valley',
          'shortDescription': 'Remote valley with rich biodiversity and ecotourism potential.',
          'fullDescription': 'The Areng Valley is a pristine natural area within the Cardamom Mountains, known for its rich biodiversity, waterfalls, and community-based ecotourism projects. It\'s ideal for adventurous nature lovers and responsible tourism, offering unique wildlife viewing opportunities.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/EE82EE/FFFFFF?text=Areng+Valley+1',
            'https://via.placeholder.com/600x400/EE82EE/FFFFFF?text=Areng+Valley+2',
            'https://via.placeholder.com/600x400/EE82EE/FFFFFF?text=Areng+Valley+3'
          ],
          'location': 'Thma Bang District',
          'latitude': 11.6900,
          'longitude': 103.3800,
          'bestTime': 'Dry season for trekking.'
        },
      ],
      'hotels': [
        {
          'name': 'Pursat Riverside Hotel',
          'shortDescription': 'Comfortable stay by the river.',
          'fullDescription': 'A pleasant hotel located by the Pursat River, offering comfortable rooms and a good base for exploring the town and surrounding areas, including access to the Cardamom Mountains. It\'s a tranquil spot for a restful night with views of the river.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/DDA0DD/FFFFFF?text=Pursat+Hotel+1'
          ],
          'location': 'Pursat City',
          'latitude': 12.5333,
          'longitude': 103.9167,
          'rating': 3.0,
          'priceRange': '\$\$'
      ...
      'places': [
        {
          ...
          'shortDescription': 'Beautiful clear water lake, popular for swimming.',
          'fullDescription': 'Yeak Laom is a stunning volcanic crater lake with exceptionally clear, warm water, surrounded by lush forest. It\'s a popular spot for swimming, picnicking, and enjoying nature, revered by local indigenous groups for its spiritual significance and pristine environment.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/FF69B4/FFFFFF?text=Yeak+Laom+1',
            'https://via.placeholder.com/600x400/FF69B4/FFFFFF?text=Yeak+Laom+2',
            'https://via.placeholder.com/600x400/FF69B4/FFFFFF?text=Yeak+Laom+3',
            'https://via.placeholder.com/600x400/FF69B4/FFFFFF?text=Yeak+Laom+4',
            'https://via.placeholder.com/600x400/FF69B4/FFFFFF?text=Yeak+Laom+5'
          ],
          'location': 'Banlung',
          'latitude': 13.7370,
          'longitude': 107.0130,
      ...
      'hotels': [
        {
          ...
          'shortDescription': 'Charming lodge in Banlung.',
          'fullDescription': 'Terres Rouges Lodge is a charming, colonial-style lodge with a beautiful garden, pool, and comfortable rooms, offering a peaceful and upscale experience in the heart of Ratanakiri. It\'s praised for its unique ambiance and service, providing a comfortable base for jungle explorations.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/DB7093/FFFFFF?text=Terres+Rouges+1',
            'https://via.placeholder.com/600x400/DB7093/FFFFFF?text=Terres+Rouges+2',
            'https://via.placeholder.com/600x400/DB7093/FFFFFF?text=Terres+Rouges+3'
          ],
          'location': 'Banlung',
          'latitude': 13.7300,
          'longitude': 106.9900,
          'rating': 4.5,
          'priceRange': '\$\$\$',
          'amenities': ['Pool', 'Restaurant', 'Garden', 'Boutique Hotel', 'Free Wi-Fi', 'Bar']
        },
      ]
    },
    {
      ...
      'places': [
        {
          ...
          'shortDescription': 'Another spot to potentially see Irrawaddy dolphins.',
          'fullDescription': 'Similar to Kratie, Stung Treng also offers opportunities to spot the rare Irrawaddy dolphins in dedicated conservation areas along the Mekong River. It\'s a peaceful and rewarding wildlife experience, often done via local boat tours that support local communities.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/ADD8E6/000000?text=Mekong+Dolphins+1',
            'https://via.placeholder.com/600x400/ADD8E6/000000?text=Mekong+Dolphins+2'
          ],
      ...
      'hotels': [
        {
          'name': 'Stung Treng Guesthouse',
          'shortDescription': 'Simple and clean accommodation.',
          'fullDescription': 'A straightforward guesthouse offering essential amenities and a clean, comfortable stay for travelers exploring the remote and natural beauty of Stung Treng province. It provides a practical and budget-friendly base for adventurers.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/4682B4/FFFFFF?text=Stung+Treng+Guesthouse+1'
          ],
    ...
    },
    {
      ...
      'places': [
        {
          ...
          'shortDescription': 'Major border crossing to Vietnam.',
          'fullDescription': 'Bavet is a bustling border town and the main land crossing between Cambodia and Vietnam. It\'s a commercial hub with casinos and markets, offering a unique cross-border atmosphere and economic activity. Be prepared for a busy environment.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/6A5ACD/FFFFFF?text=Bavet+Border+1'
          ],
          'location': 'Bavet',
          'latitude': 11.0833,
          'longitude': 106.1833,
      ...
      'hotels': [
        {
          'name': 'Svay Rieng Hotel',
          'shortDescription': 'Local hotel for travelers.',
          'fullDescription': 'A suitable local hotel providing standard accommodation for travelers passing through or staying in Svay Rieng, offering basic amenities and a convenient location for exploring the provincial town. It serves as a practical stop for those on their way to or from Vietnam.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/483D8B/FFFFFF?text=Svay+Rieng+Hotel+1'
          ],
          ...
          'rating': 2.8,
          'priceRange': '\$\$',
          'amenities': ['Restaurant', 'Parking', '24-hour Reception']
        },
      ]
    },
    {
      ...
      'places': [
        {
          ...
          'shortDescription': 'Ancient Funan-era sites, important archaeological discoveries.',
          'fullDescription': 'Phnom Da and Angkor Borei are significant archaeological sites dating back to the Funan Kingdom (1st-6th century AD), featuring ancient temples and pre-Angkorian ruins, crucial for understanding early Cambodian history and development. A boat trip is often needed to access these sites.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/800000/FFFFFF?text=Phnom+Da+1',
            'https://via.placeholder.com/600x400/800000/FFFFFF?text=Phnom+Da+2',
            'https://via.placeholder.com/600x400/800000/FFFFFF?text=Phnom+Da+3',
            'https://via.placeholder.com/600x400/800000/FFFFFF?text=Phnom+Da+4',
            'https://via.placeholder.com/600x400/800000/FFFFFF?text=Phnom+Da+5'
          ],
      ...
      'hotels': [
        {
          'name': 'Phnom Da Resort & Restaurant',
          'shortDescription': 'Accommodation near historical sites.',
          'fullDescription': 'Phnom Da Resort & Restaurant offers comfortable lodging and dining options conveniently located near the ancient sites of Phnom Da and Angkor Borei, perfect for historical explorations and a tranquil retreat. It provides a unique stay experience.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/DC143C/FFFFFF?text=Phnom+Da+Resort+1'
          ],
          'location': 'Takéo',
          'latitude': 10.8700,
          'longitude': 104.9300,
    ...
    },
    {
      ...
      'places': [
        {
          'name': 'Suong Market',
          'shortDescription': 'A bustling local market with fresh produce and goods.',
          'fullDescription': 'Suong Market is a vibrant local market that offers a genuine insight into daily Cambodian life. You can find a variety of fresh produce, street food, and traditional goods here, making it a great place for cultural immersion and authentic experiences.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/FF4500/FFFFFF?text=Suong+Market+1'
          ],
          'location': 'Suong City',
          'latitude': 11.9610,
          'longitude': 105.7950,
      ...
      'hotels': [
        {
          'name': 'Koh Thum Resort',
          'shortDescription': 'Riverside resort offering relaxation.',
          'fullDescription': 'Koh Thum Resort provides a tranquil setting by the river, offering comfortable bungalows and a peaceful atmosphere for guests to relax and enjoy the rural Cambodian scenery. Ideal for a quiet getaway and enjoying nature.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/FF7F50/FFFFFF?text=Koh+Thum+Resort+1'
          ],
    ...
    },
    {
      ...
      'places': [
        {
          'name': 'Angkor Kdei',
          'shortDescription': 'Ancient temple with historical significance.',
          'fullDescription': 'Angkor Kdei is a lesser-known but significant ancient site offering a glimpse into Cambodia\'s rich past without the crowds of larger complexes. It features interesting stone carvings and a peaceful atmosphere.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/5733FF/FFFFFF?text=Angkor+Kdei+1',
            'https://via.placeholder.com/600x400/5733FF/FFFFFF?text=Angkor+Kdei+2',
            'https://via.placeholder.com/600x400/5733FF/FFFFFF?text=Angkor+Kdei+3'
          ],
          'location': 'Sisophon',
          'latitude': 13.5800,
          'longitude': 102.9700,
          'bestTime': 'Anytime, relatively quiet.'
        },
      ],
      'hotels': [
        {
          'name': 'Banteay Meanchey Inn',
          'shortDescription': 'Cozy stay with local charm.',
          'fullDescription': 'A comfortable and welcoming inn, perfect for travelers looking for an authentic local experience with basic but clean amenities. It provides a quiet retreat after a day of exploration.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/800080/FFFFFF?text=Banteay+Meanchey+Inn+1',
            'https://via.placeholder.com/600x400/800080/FFFFFF?text=Banteay+Meanchey+Inn+2'
          ],
          'location': 'Sisophon',
          'latitude': 13.5850,
          'longitude': 102.9730,
          'rating': 3.5,
          'priceRange': '\$',
          'amenities': ['Free Wi-Fi', 'Garden', '24-hour Front Desk']
        },
      ]
    },
    {
      ...
      'places': [
        {
          ...
          'shortDescription': 'A beautiful, quieter island perfect for relaxation.',
          'fullDescription': 'Koh Rong Samloem is a quieter and more laid-back alternative to Koh Rong, known for its pristine beaches like Saracen Bay and M\'Pai Bay, clear waters, and stunning natural beauty. Ideal for relaxation, snorkeling, and enjoying tranquil island life.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/87CEFA/FFFFFF?text=Koh+Rong+Samloem+1',
            'https://via.placeholder.com/600x400/87CEFA/FFFFFF?text=Koh+Rong+Samloem+2',
            'https://via.placeholder.com/600x400/87CEFA/FFFFFF?text=Koh+Rong+Samloem+3',
            'https://via.placeholder.com/600x400/87CEFA/FFFFFF?text=Koh+Rong+Samloem+4',
            'https://via.placeholder.com/600x400/87CEFA/FFFFFF?text=Koh+Rong+Samloem+5'
          ],
          'location': 'Off Sihanoukville Coast',
          'latitude': 10.5900,
          'longitude': 103.2600,
          'bestTime': 'Dry season.'
        },
      ...
      'hotels': [
        {
          'name': 'The Secret Garden at Otres Beach',
          'shortDescription': 'Charming bungalows by the beach.',
          'fullDescription': 'The Secret Garden offers charming and comfortable bungalows set amidst a beautiful garden directly on Otres Beach, providing a relaxed and idyllic beachfront escape. It\'s a peaceful haven for beach lovers seeking tranquility and natural beauty.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/B0E0E6/000000?text=Secret+Garden+1',
            'https://via.placeholder.com/600x400/B0E0E6/000000?text=Secret+Garden+2',
            'https://via.placeholder.com/600x400/B0E0E6/000000?text=Secret+Garden+3'
          ],
          ...
          'rating': 4.2,
          'priceRange': '\$\$\$',
          'amenities': ['Beachfront', 'Pool', 'Restaurant', 'Garden', 'Free Wi-Fi', 'Bar']
        },
      ]
    },
    {
      ...
      'places': [
        {
          ...
          'shortDescription': 'A small island perfect for a day trip or overnight stay.',
          'fullDescription': 'Take a short boat ride to Rabbit Island, a tranquil paradise with pristine beaches, clear waters, and simple bungalows, ideal for relaxing and swimming away from the mainland. It\'s a popular spot for snorkeling and enjoying unspoiled nature.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/00FF00/000000?text=Rabbit+Island+1',
            'https://via.placeholder.com/600x400/00FF00/000000?text=Rabbit+Island+2',
            'https://via.placeholder.com/600x400/00FF00/000000?text=Rabbit+Island+3',
            'https://via.placeholder.com/600x400/00FF00/000000?text=Rabbit+Island+4',
            'https://via.placeholder.com/600x400/00FF00/000000?text=Rabbit+Island+5'
          ],
          'location': 'Off Kep Coast',
          'latitude': 10.4500,
          'longitude': 104.3000,
          'bestTime': 'Anytime.'
        },
      ...
      'hotels': [
        {
          ...
          'shortDescription': 'Eco-friendly resort with hillside bungalows.',
          'fullDescription': 'Veranda Natural Resort is a charming, eco-friendly retreat offering unique hillside bungalows, a refreshing pool, and stunning views of the ocean and surrounding nature. It\'s praised for its peaceful ambiance and sustainable practices, providing a truly harmonious stay.',
          'imageUrls': [
            'https://via.placeholder.com/600x400/CD853F/FFFFFF?text=Veranda+Resort+1',
            'https://via.placeholder.com/600x400/CD853F/FFFFFF?text=Veranda+Resort+2',
            'https://via.placeholder.com/600x400/CD853F/FFFFFF?text=Veranda+Resort+3'
          ],
          'location': 'Kep City',
          'latitude': 10.4800,
          'longitude': 104.2800,
          'rating': 4.5,
          'priceRange': '\$\$\$',
          'amenities': ['Pool', 'Restaurant', 'Nature Walks', 'Eco-friendly', 'Views', 'Massage']
        },
      ]
    },
    {
