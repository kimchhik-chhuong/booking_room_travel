        ...
        child: Column(
          ...
          children: [
            ...
            _buildNextStepItem(
              ...
              'Directions',
              'Get directions to the hotel and plan your journey.',
            ),
            _buildNextStepItem(
              Icons.phone_outlined,
              'Contact Hotel',
              'Call the hotel directly for any special requests or questions.',
            ),
            _buildNextStepItem(
              Icons.calendar_today_outlined,
              'Check-in Reminder',
              'We\'ll send you a reminder 24 hours before your check-in date.',
            ),
          ],
        ),
      ),
      ...
      children: [
        ...
        SizedBox(
          ...
          child: OutlinedButton.icon(
            onPressed: () {
              // Navigate to booking history or my bookings page
