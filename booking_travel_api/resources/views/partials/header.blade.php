        ...
        <div class="flex items-center space-x-6">
            ...
            <div class="relative">
                <input type="text" 
                       ...
                       class="w-80 pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 transition-all hover:bg-white">
            ...
            <!-- User Profile -->
            <div class="flex items-center space-x-3 bg-gray-50 rounded-xl p-2 hover:bg-gray-100 transition-all cursor-pointer card-hover">
